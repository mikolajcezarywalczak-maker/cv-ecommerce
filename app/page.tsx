...
export default function Page() {
  ...
  const [checkoutStep, setCheckoutStep] = useState("cart"); // 'cart' lub 'checkout'

  // Pakiety/Skille jako produkty do koszyka
  const products = [
    { 
      id: 1,
  ...
  // Funkcja działająca jako włącz/wyłącz (Toggle)
  const toggleCartItem = (product) => {
    if (cartItems.find(item => item.id === product.id)) {
      ...
      setCartOpen(true);
      setCheckoutStep("cart"); // Zawsze otwieraj na widoku koszyka
    }
  };
    ...
    <>
      ...
      <div style={{ minHeight: "100vh" }}>
              ...
              {products.map((p) => {
                ...
                return (
                  <article key={p.id} className="product-card" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    {/* Zmiana na kwadrat: aspectRatio: "1/1" */}
        ...
        <aside style={{
          ...
          {/* Nagłówek koszyka (ukrywany w finalizacji dla czystszego widoku) */}
          {checkoutStep === "cart" && (
          ...
          <div style={{ flex: 1, overflowY: "auto" }}>
            ...
            {checkoutStep === "checkout" && (
              <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
                ...
                {/* TUTAJ ZMIEŃ TEKST NA SWÓJ ŚMIESZNY */}
          ...
          {/* STOPKA KOSZYKA (Tylko w widoku koszyka) */}
